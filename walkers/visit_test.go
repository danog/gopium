			...
			sts: map[string]gopium.Struct{
				...
				"tests_data_flat_file.go:16": {
					...
					Fields: []gopium.Field{
						{
							Name:     "A",
							Type:     "github.com/danog/gopium/tests/data/flat.A",
							Size:     8,
							Align:    8,
							Exported: true,
							Embedded: true,
				...
				"tests_data_flat_file.go:21": {
					...
					Fields: []gopium.Field{
						...
						{
							Name:     "A",
							Type:     "struct{b github.com/danog/gopium/tests/data/flat.b; z github.com/danog/gopium/tests/data/flat.A}",
							Size:     24,
							Align:    8,
							Exported: true,
						},
				...
				"tests_data_flat_file.go:41": {
					...
					Fields: []gopium.Field{
						...
						{
							Name:     "D",
							Type:     "github.com/danog/gopium/tests/data/flat.D",
							Size:     24,
							Align:    8,
							Exported: true,
						},
			...
			sts: map[string]gopium.Struct{
				...
				"tests_data_nested_file.go:11": {
					...
					Fields: []gopium.Field{
						{
							Name:     "A",
							Type:     "github.com/danog/gopium/tests/data/nested.A",
							Size:     8,
							Align:    8,
							Exported: true,
							Embedded: true,
				...
				"tests_data_nested_file.go:16": {
					...
					Fields: []gopium.Field{
						...
						{
							Name:     "A",
							Type:     "struct{b github.com/danog/gopium/tests/data/nested.b; z github.com/danog/gopium/tests/data/nested.A}",
							Size:     24,
							Align:    8,
							Exported: true,
						},
				...
				"tests_data_nested_file.go:63": {
					...
					Fields: []gopium.Field{
						...
						{
							Name:     "C",
							Type:     "github.com/danog/gopium/tests/data/nested.C",
							Size:     48,
							Align:    8,
							Ptr:      8,
							Exported: true,
			...
			sts: map[string]gopium.Struct{
				...
				"tests_data_nested_file.go:25": {
					...
					Fields: []gopium.Field{
						{
							Name:     "b",
							Type:     "github.com/danog/gopium/tests/data/nested.b",
							Size:     16,
							Align:    8,
							Embedded: true,
						},
